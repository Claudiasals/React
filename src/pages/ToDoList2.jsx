...
const ToDoList2 = () => {
  // Recupero i dati globali dal Context (creato e gestito in TodoProvider)
  ...
  */
  ...
  useEffect(() => {
    if (inputRef.current) {
      ...
      quindi il componente ha finito di ricevere i dati dal provider.
  ...
  // utilizzo useMemo per memorizzare il risultato del filtro e riaggiornarlo
  ...
  const filteredTodos = useMemo(() => {
    ...
    // search ?? "" ---> assicura che non sia null o undefined
  ...
  // mostro i msg di loading e di errore, perché dal provider 
...
--> Problema risolto: l’input viene sempre renderizzato e il focus può essere applicato. */
